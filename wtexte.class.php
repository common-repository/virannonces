<?PHP
 /*
 * VirannoncesTexteWidget Class
 */
class VirannoncesTexteWidget extends WP_Widget {
	/** constructor */
	function VirannoncesTexteWidget() {
		parent::WP_Widget(false, $name = 'Virannonces Widget Texte');
	}
